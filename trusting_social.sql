...
alter table trustingsocial.mkt_data
add column channel_cost DECIMAL(10, 3)

update trustingsocial.mkt_data
set channel_cost = 
    case 
...
from trustingsocial.mkt_data md 
order by send_date 
...
(
	...
	from trustingsocial.mkt_data as a
